...
// Load colours
$bg 		= get_option( 'colorshop_email_background_color' );
$body		= get_option( 'colorshop_email_body_background_color' );
$base 		= get_option( 'colorshop_email_base_color' );
$base_text 	= colorshop_light_or_dark( $base, '#202020', '#ffffff' );
$text 		= get_option( 'colorshop_email_text_color' );

$bg_darker_10 = colorshop_hex_darker( $bg, 10 );
$base_lighter_20 = colorshop_hex_lighter( $base, 20 );
$text_lighter_20 = colorshop_hex_lighter( $text, 20 );
        	...
        	<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
            	<tr>
                	<td align="center" valign="top">
                		<?php
                			if ( $img = get_option( 'colorshop_email_header_image' ) ) {
