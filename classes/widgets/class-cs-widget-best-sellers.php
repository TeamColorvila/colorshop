...
class CS_Widget_Best_Sellers extends WP_Widget {
	 ...
	 * @return void
	 */
	function CS_Widget_Best_Sellers() {

		/* Widget variable settings. */
		$this->color_widget_cssclass = 'colorshop widget_best_sellers';
		$this->color_widget_description = __( 'Display a list of your best selling products on your site.', 'colorshop' );
		$this->color_widget_idbase = 'colorshop_best_sellers';
		$this->color_widget_name = __( 'ColorShop Best Sellers', 'colorshop' );

		/* Widget settings. */
		$widget_ops = array( 'classname' => $this->color_widget_cssclass, 'description' => $this->color_widget_description );

		/* Create the widget. */
		$this->WP_Widget('best_sellers', $this->color_widget_name, $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Best Sellers', 'colorshop' ) : $instance['title'], $instance, $this->id_base);
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('hide_free'); ?>"><?php _e( 'Hide free products', 'colorshop' ); ?></label></p>
