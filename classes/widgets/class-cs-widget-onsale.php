...
class CS_Widget_Onsale extends WP_Widget {
	 ...
	 * @return void
	 */
	function CS_Widget_Onsale() {

		/* Widget variable settings. */
		$this->color_widget_cssclass = 'colorshop widget_onsale';
		$this->color_widget_description = __( 'Display a list of your on-sale products on your site.', 'colorshop' );
		$this->color_widget_idbase = 'colorshop_onsale';
		$this->color_widget_name = __( 'ColorShop On-sale', 'colorshop' );

		/* Widget settings. */
		$widget_ops = array( 'classname' => $this->color_widget_cssclass, 'description' => $this->color_widget_description );

		/* Create the widget. */
		$this->WP_Widget('onsale', $this->color_widget_name, $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('On Sale', 'colorshop' ) : $instance['title'], $instance, $this->id_base);
