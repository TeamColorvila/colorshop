...
class CS_Widget_Featured_Products extends WP_Widget {
	 ...
	 * @return void
	 */
	function CS_Widget_Featured_Products() {

		/* Widget variable settings. */
		$this->color_widget_cssclass = 'colorshop widget_featured_products';
		$this->color_widget_description = __( 'Display a list of featured products on your site.', 'colorshop' );
		$this->color_widget_idbase = 'colorshop_featured_products';
		$this->color_widget_name = __( 'ColorShop Featured Products', 'colorshop' );

		/* Widget settings. */
		$widget_ops = array( 'classname' => $this->color_widget_cssclass, 'description' => $this->color_widget_description );

		/* Create the widget. */
		$this->WP_Widget('featured-products', $this->color_widget_name, $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Featured Products', 'colorshop' ) : $instance['title'], $instance, $this->id_base);
