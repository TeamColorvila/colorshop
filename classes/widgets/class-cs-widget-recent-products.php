...
class CS_Widget_Recent_Products extends WP_Widget {
	 ...
	 * @return void
	 */
	function CS_Widget_Recent_Products() {

		/* Widget variable settings. */
		$this->color_widget_cssclass = 'colorshop widget_recent_products';
		$this->color_widget_description = __( 'Display a list of your most recent products on your site.', 'colorshop' );
		$this->color_widget_idbase = 'colorshop_recent_products';
		$this->color_widget_name = __( 'ColorShop Recent Products', 'colorshop' );

		/* Widget settings. */
		$widget_ops = array( 'classname' => $this->color_widget_cssclass, 'description' => $this->color_widget_description );

		/* Create the widget. */
		$this->WP_Widget('recent_products', $this->color_widget_name, $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('New Products', 'colorshop' ) : $instance['title'], $instance, $this->id_base);
...
?>
		...
		<label for="<?php echo $this->get_field_id('show_variations'); ?>"><?php _e( 'Show hidden product variations', 'colorshop' ); ?></label></p>
