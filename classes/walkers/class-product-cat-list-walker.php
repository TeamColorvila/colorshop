<?php
/**
 * CS_Product_Cat_List_Walker class.
 *
 * @extends 	Walker
 * @class 		CS_Product_Cat_Dropdown_Walker
 * @version		1.0.0
 * @package		ColorShop/Classes/Walkers
 * @author 		ColorVila
 */

if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

class CS_Product_Cat_List_Walker extends Walker {
	...
	function start_el( &$output, $cat, $depth, $args ) {
		...
		$output .=  '"><a href="' . get_term_link( (int) $cat->term_id, 'product_cat' ) . '">' . __( $cat->name, 'colorshop' ) . '</a>';
