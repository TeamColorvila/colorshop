 ...
 *
 * @class 		CS_Product_Grouped
 * @version		1.0.0
 * @package		ColorShop/Classes/Products
 * @category	Class
 * @author 		ColorVila
 */
class CS_Product_Grouped extends CS_Product {
	...
	public function get_price_html( $price = '' ) {
		...
		$price .= colorshop_price( $min_price );

		$price = apply_filters( 'colorshop_grouped_price_html', $price, $this );
