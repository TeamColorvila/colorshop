...
<div class="wrap">
    ...
    <div id="visual-options">
    	<table class="form-table">
    		<tr>
    			<th class="titledesc" scope="row"><?php _e( 'Button style', 'colorshop' ); ?></th>
    			<td class="forminp">
    				<fieldset>
    					<legend class="screen-reader-text"><span><?php _e( 'Button style', 'colorshop' ); ?></span></legend>
						<p>
							<label>
        ...
        <div class="submit">
        	<input type="submit" class="button button-primary" name="syc-visual-form" value="<?php _e('Save changes', 'colorshop'); ?>" />
        </div>
    </div>
</div>