 ...
 * @author 		ColorVila
 * @category 	Shortcodes
 * @package 	ColorShop/Shortcodes/Edit_Address
 * @version     1.0.0
 */

class CS_Shortcode_Edit_Address {
	...
	public static function output( $atts ) {
		...
		$address = $colorshop->countries->get_address_fields( get_user_meta( get_current_user_id(), $load_address . '_country', true ), $load_address . '_' );

		colorshop_get_template( 'myaccount/form-edit-address.php', array(
