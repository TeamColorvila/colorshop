...
// Update colorshop_downloadable_product_permissions table to include order ID's as well as keys
$results = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}colorshop_downloadable_product_permissions WHERE order_id = 0;" );
